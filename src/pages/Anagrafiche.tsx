...
const Anagrafiche = () => {
  ...
  const getFormSchemaKeys = (tab: string) => {
    switch (tab) {
      ...
      case "punti-servizio":
        return ["nomePuntoServizio", "idCliente", "indirizzo", "citta", "cap", "provincia", "referente", "telefonoReferente", "telefono", "email", "note", "tempoIntervento", "fornitoreId", "codiceCliente", "codiceSicep", "codiceFatturazione", "latitude", "longitude"];
      case "personale":
      ...
      case "tariffe": // New case for Tariffe
        return ["cliente_id", "tipo_servizio", "importo", "supplier_rate", "unita_misura", "punto_servizio_id", "fornitore_id", "data_inizio_validita", "data_fine_validita", "note"];
      default:
        return [];
    }
  };
