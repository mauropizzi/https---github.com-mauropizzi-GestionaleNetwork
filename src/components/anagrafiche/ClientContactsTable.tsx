...
import { Edit, Trash2, RefreshCcw, PlusCircle } from "lucide-react";
import { showInfo, showError, showSuccess } from "@/utils/toast";
import { supabase } from "@/integrations/supabase/client";
import { ClientContactDialog } from "./ClientContactDialog"; // Import the new dialog
...
export function ClientContactsTable({ clientId }: ClientContactsTableProps) {
  ...
  const handleAddContact = useCallback(() => {
    setSelectedContactForEdit(null); // Clear any previous selection
  ...
  const handleSave = useCallback(() => {
    fetchClientContacts(); // Re-fetch data to ensure consistency
